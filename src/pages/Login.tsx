...
export default function Login() {
  ...
  const { login } = useAuth();
  const [email, setEmail] = useState("student@mathematicclasses.com");
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    toast.error("Invalid credentials. Try student@mathematicclasses.com / student123");
  };
        ...
        <div className="mc-container max-w-md">
          <div className="mc-card p-6 sm:p-8">
            ...
            <form onSubmit={submit} className="mt-6 space-y-4">
              <div>
                ...
                <div className="relative mt-1.5">
                  ...
                  <Input id="email" value={email} onChange={(e) => setEmail(e.target.value)} className="pl-9" placeholder="student@mathematicclasses.com" />
                </div>
              </div>
            ...
            <p className="mt-5 text-center text-xs text-slate-500 dark:text-slate-400">
              Demo credentials: student@mathematicclasses.com / student123
            </p>
          </div>
        </div>
      </section>
